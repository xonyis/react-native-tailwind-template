...
export default function HebergementEditScreen() {
  ...
  useEffect(() => {
    if (hebergement) {
      ...
      if (hebergement.dateCreation) {
        setSelectedCreationDate(new Date(hebergement.dateCreation));
      }
    }
  }, [hebergement]);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Heading2 style={styles.headerTitle}>Modifier hébergement</Heading2>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={[styles.pickerButton, styles.readOnlyField]}>
                <BodyText style={styles.pickerText}>
                  {hebergement.client ? `${hebergement.client.nom} - ${hebergement.client.ville || 'Ville non spécifiée'}` : 'Client non trouvé'}
                </BodyText>
              </View>
            </View>
