...
import { NexLeasesScreen } from '@/components/nexlease/NexLeasesScreen';
...
export default function NexLeasePage() {
  const navigation = useNavigation();
  const router = useRouter();

  const handleCreateNexLease = () => {
    router.push({
      pathname: '/(drawer)/nexlease-new',
      params: {}
    });
  };
    ...
    <View style={{ flex: 1, backgroundColor: "#fff"}}>
      ...
      <ThemedView className="p-6 border-b border-gray-200" lightColor="#ffffff" darkColor="#000000">
        ...
        <BodyText style={{ color: "#666", textAlign: "center" }}>
          Gérez vos NexLease et consultez leurs informations
        </BodyText>
      </ThemedView>
