  ...
  return (
    <View style={{ flex: 1 }}>
      <ThemedView className="flex-1 items-center justify-center p-6" lightColor="#ffffff" darkColor="#000000">
        <ThemedText className="text-3xl font-bold text-black">Services Web</ThemedText>
        <ThemedText className="mt-2 text-black dark:text-gray-300">Placeholder écran Services Web</ThemedText>
      </ThemedView>
